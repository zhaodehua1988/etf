...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		EIP155Block:         big.NewInt(2469473),
		EIP158Block:         big.NewInt(2469473),
		//EIP155Block:         big.NewInt(2675000),
		//EIP158Block:         big.NewInt(2675000),
		ByzantiumBlock:      big.NewInt(4370000),
		ETFForkBlock:        big.NewInt(4730660),
		ETFRefundContractBlock:   big.NewInt(2469483),
		ETFRefundContractSupport: true,
		ConstantinopleBlock: nil,
		Ethash:              new(EthashConfig),
	}

	// origin ethereum Ropsten test network config
	...
	// TestnetChainConfig contains the chain parameters to run a node on the etf test network.
	TestnetChainConfig = &ChainConfig{
		ChainId:             big.NewInt(198),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
	...
	// origin ethereum Rinkeby test network config
...
func (c *ChainConfig) CheckCompatible(newcfg *ChainConfig, height uint64) *ConfigCompatError {
	...
	log.Info("CheckCompatible","storedcfg ChainID",c.ChainId,"|newcfg ChainID",newcfg.ChainId,"height",height)
